...
["Color Hub 2"] = Color3.fromRGB(0, 0, 130),     -- لون التاب أزرق غامق
			["Color Stroke"] = Color3.fromRGB(0, 0, 70),     -- حدود غامقة
			["Color Theme"] = Color3.fromRGB(20, 20, 150),   -- أساس التيم أزرق متوسط
			["Color Text"] = Color3.fromRGB(230, 230, 255),  -- نص فاتح
			["Color Dark Text"] = Color3.fromRGB(130, 130, 180), -- نص داكن
		},
		Dark = {
			["Color Hub 1"] = ColorSequence.new({
		...
		Purple = {
    ["Color Hub 1"] = ColorSequence.new({
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 40)),    -- أزرق غامق جداً
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 0, 120)),   -- أزرق متوسط
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(50, 50, 200))  -- أزرق فاتح
    }),
    ["Color Hub 2"] = Color3.fromRGB(0, 0, 130),     -- لون التاب أزرق غامق
    ["Color Stroke"] = Color3.fromRGB(0, 0, 70),     -- حدود غامقة
    ["Color Theme"] = Color3.fromRGB(20, 20, 150),   -- أساس التيم أزرق متوسط
    ["Color Text"] = Color3.fromRGB(230, 230, 255),  -- نص فاتح ليتباين مع الخلفية
    ["Color Dark Text"] = Color3.fromRGB(130, 130, 180),
    ["Color Dark Purple"] = Color3.fromRGB(0, 0, 90), -- ظل أزرق غامق
    ["Color Hub 9"] = Color3.fromRGB(20, 20, 170),   -- خلفية رئيسية أزرق متوسط
    ["Color Dark Greem"] = Color3.fromRGB(0, 0, 50)  -- خلفية داكنة أزرق غامق جداً
}
	},
	Info = {
		Version = "1.1.0"
